...
import { GoogleMapsLoaderZone } from "../googleMapsLoaderZone/googleMapsLoaderZone";
...
const GoogleMapClientComponentZone = ({
  LANGUAGE,
  markersData,
  mapType,
  zoneCircle,
...
export default GoogleMapClientComponentZone;
