...
import { lastFuelReportDataMock } from "@/global/dataMock/lastFuelReportData";
...
export const FuelNowTab = ({
  ...
  useEffect(() => {
    if (lastFuelReportDataMock) {
      setGeoModalData({
        lat: parseFloat(lastFuelReportDataMock.lat.toString()),
        lon: parseFloat(lastFuelReportDataMock.lon.toString()),
        title: LANGUAGE.geoModalTitles.fuelNowTitle,
        rows: [],
      });
    }
  }, [lastFuelReportDataMock, LANGUAGE]);
    ...
    <>
      {
        ...
        <>
          <FuelNowContainer
            ...
            lastFuelReportData={lastFuelReportDataMock}
