...
import { GoogleMapsSeveralMarkersLoader } from "./googleMapsSeveralMarkersLoader";
...
const GoogleMapClientComponent = ({ LANGUAGE, places, mapType }: Props) => {
  ...
  return (
    <>
      {googleApiKey && (
        <GoogleMapsSeveralMarkersLoader
          LANGUAGE={LANGUAGE}
          places={places}
