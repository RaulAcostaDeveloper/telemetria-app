...
export const SPANISH: LanguageInterface = {
  ...
  notifications: {
    ...
    tooManyRequest: "Se alcanzó el número de peticiones.",
    pleaseReTry: "Por favor, intente de nuevo después de unos segundos.",
  },
  header: {
    backButton: {
      hover: "Regresar",
  ...
  highCharts: {
    ...
    tooltips: {
      ...
      fuel: {
        ...
        subtitleCharges: "Detalles",
        subtitleDischarges: "Detalles",
        subtitleFuelVariationCAN: "Detalles",
        subtitlePerformanceBetween: "Detalles",
      },
      rpm: {
  ...
  fuel: {
    ...
    vehiclesTableColumns: {
      ...
      performanceOdometer: "Rendimiento (Odo Km/L)",
  ...
  fuelVehicle: {
    ...
    fuelNow: {
      ...
      startSynchronization: "No sincronizando",
