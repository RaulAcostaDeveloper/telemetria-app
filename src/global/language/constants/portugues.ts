...
export const PORTUGUES: LanguageInterface = {
  ...
  highCharts: {
    ...
    tooltips: {
      ...
      fuel: {
        ...
        subtitleCharges: "Detalhes",
        subtitleDischarges: "Detalhes",
        subtitleFuelVariationCAN: "Detalhes",
        subtitlePerformanceBetween: "Detalhes",
      },
      rpm: {
  ...
  fuelVehicle: {
    ...
    fuelNow: {
      ...
      stopSynchronization: "Sincronizando",
      startSynchronization: "Não sincronizando",
      startedSynch: "A sincronização foi iniciada",
      stoppedSynch: "A sincronização foi interrompida",
    },
    fuelChargesLabels: {
